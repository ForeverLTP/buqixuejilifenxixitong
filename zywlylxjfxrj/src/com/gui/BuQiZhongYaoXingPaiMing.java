...
public class BuQiZhongYaoXingPaiMing extends JFrame {
	...
	static String[] everytablexiaofenzipaiming = new String[100000];//依次存放每张表的小分子重要排名
	static int[] everytablexiaofenzicishu = new int[100000];//依次存放每张表的靶标重要性排名
	...
	public static void Buqixiaofenzipaiming(String[] buqiroad1){
		...
		try{
			...
			//File file2 = new File(filename2);//黄芪
			...
			for(i = 0;i<sheet1.getRows();i ++){  //当归 行
       ...
       /* for(Entry<String, Integer> vo : map.entrySet()){ 
        ...
        for (i = infoIds.size()-1; i >= 0 ; i--) {     //从后往前输出
           ...
           // System.out.println(ent.getKey()+"="+ent.getValue()); 
			 ...
			 List<Map.Entry<String, Integer>> infoIds1 = new ArrayList<Map.Entry<String, Integer>>(map3.entrySet()); //小分子整合
		     Collections.sort(infoIds1, new Comparator<Map.Entry<String, Integer>>() {  //小分子
      ...
      //导出小分子重要性排名txt文件***********************************************************************************
		...
		FileOutputStream fs1 = new FileOutputStream(new File(path+"/"+file3name3+"补气小分子重要性.txt")); //file1.getName().substring(0, file1.getName().indexOf("."))去掉文件后缀名
...
/*        System.out.println("--------------排序后--------------");  //小分子
      ...
      //导出小分子重要性排名txt文件***********************************************************************************
       ...
       /* String file3name3="", file4name4="";
		...
		FileOutputStream fs2 = new FileOutputStream(new File(path+"/补气靶标重要性.txt")); //file1.getName().substring(0, file1.getName().indexOf("."))去掉文件后缀名
