...
import jxl.Workbook;
 ...
 class BuqiDetail {
	...
	static class canvas1 extends Canvas {
		  //static int a,b,s;
			
			/**
		 * 
		 */
		private static final long serialVersionUID = -3659003098125932499L;
		...
		public void paint(Graphics g) {
			...
			//按照上面顺序进行画
			g.drawString(canvas.s1, 252, 60);
			
			g.drawString(canvas.h1 , 252, 85);
			
			g.drawString(canvas.xishu2 , 247, 110);
			
			
			g.drawString(String.valueOf(canvas.zhongxindu2) , 247,135);
			
			g.drawString(canvas.m1, 251, 160);
