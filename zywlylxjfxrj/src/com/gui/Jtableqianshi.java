...
public class Jtableqianshi {   //创建一个Dialog显示一下
	static class ModelDemo1 extends AbstractTableModel
	{
	       /**
		 * 
		 */
		private static final long serialVersionUID = -2618858787252105368L;
		private Vector<String[]> TableData;//用来存放表格数据的线性表
	       ...
	       public void Demo(String[] strr, String[] strr1)
	       {
	              ...
	              TableTitle.add("第三列");
	      //        TableTitle.add("第三列");
	              String[] first = {"序号","补气中药靶标名称","补血中药靶标名称"};
	              TableData.add(first);
...
//		  System.arraycopy(str1, 0, strr1, 0, str.length);
          ...
          jf.setTitle("共同靶标在补血中药和补气中药排名都靠前的靶标对比(各取前10个)");
