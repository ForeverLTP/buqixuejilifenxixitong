...
public class paintbuxueyaolitu {
	JFrame random;
	Random r;
	canva c;
	...
	static class canva extends Canvas {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -665177703011331669L;
		static double s,h,xishu,xishu1,zhongxindu,zhongxindu1;//有无static修饰相差很大？？？？
		static double m;
		static String s1,h1,m1,xishu2,zhongxindu2;
		public static String getZhongxindu2() {
			return zhongxindu2;
		}
		public static void setZhongxindu2(String zhongxindu2) {
			canva.zhongxindu2 = zhongxindu2;
		}
...
//****		      File file = new File(filename);
		    ...
		    //扫描excel表找出小分子的数目
		      for (i = 0; i < sheet.getRows(); i++) {                     // 循环打印Excel表中的内容   ROW行   Column列
	            	  ...
	            	  {   i2=i-1;
	                	  ...
	                	  System.out.println("i222222222222222222222222222222222222="+i2);
	                	  break; 
	            	  }
	            	  else{
	                	   continue;            
		...
		//节点i的聚类系数 CC(i)=2E(i)/(k(k-1))其中E为实际的边数
		    //求聚类系数
		    	...
		    	System.out.println("111111111111111111111111111111111111111111111111111111="+i1);
		    	xishu1=xishu/(i1-3);
