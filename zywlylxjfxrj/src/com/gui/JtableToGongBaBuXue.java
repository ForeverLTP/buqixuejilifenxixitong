...
public class JtableToGongBaBuXue {   //创建一个Dialog显示一下
	static class ModelDemo1 extends AbstractTableModel
	{
	       /**
		 * 
		 */
		private static final long serialVersionUID = -3450864634020622915L;
		private Vector<String[]> TableData;//用来存放表格数据的线性表
	       ...
	       public void Demo(String[] strr, String[] strr1)
	       {
	              ...
	              TableTitle.add("第二列");
	              TableTitle.add("第三列");
	              String[] first = {"序号","靶标名称(及共同靶标标注)","指向小分子的数目"};
	              TableData.add(first);
	      //        TableTitle.add("第三列");
    ...
    { 
//		  String[] strr = new String[1000];//babiao名称
//		  String[] strr1 = new String[1000];//靶标出现次数
...
//		  System.arraycopy(str1, 0, strr1, 0, str.length);
          ...
          jf.setTitle("共同靶标在补血中药的靶标中重要性与全部补血中药靶标的排名对比");
