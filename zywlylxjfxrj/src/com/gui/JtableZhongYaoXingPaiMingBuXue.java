...
public class JtableZhongYaoXingPaiMingBuXue {   //创建一个Dialog显示一下
	static class ModelDemo1 extends AbstractTableModel
	{
	       /**
		 * 
		 */
		private static final long serialVersionUID = 8915304948059491385L;
	...
	public void huabiao(String[] str,String[] str1)
    { 
		 /* String[] strr = new String[10000];//小分子名称
		  String[] strr1 = new String[10000];//小分子出现次数
